...
///
/// {@tool dartpad}
/// This example shows a toggleable [CWCommonSwitch]. When the thumb slides to
...
/// {@tool snippet}
///
/// This sample shows how to use a [CWCommonSwitch] in a [ListTile]. The
...
class CWCommonSwitch extends StatefulWidget {
  ...
  /// {@template flutter.cupertino.CWCommonSwitch.applyTheme}
  ...
  /// {@template flutter.cupertino.CWCommonSwitch.dragStartBehavior}
  ...
  @override
  State<CWCommonSwitch> createState() => _CWCommonSwitchState();
...
class _CWCommonSwitchState extends State<CWCommonSwitch> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(CWCommonSwitch oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: Opacity(
        opacity: widget.onChanged == null ? _kCWCommonSwitchDisabledOpacity : 1.0,
        child: FocusableActionDetector(
          ...
          child: _CWCommonSwitchRenderObjectWidget(
            value: widget.value,
...
class _CWCommonSwitchRenderObjectWidget extends LeafRenderObjectWidget {
  const _CWCommonSwitchRenderObjectWidget({
    required this.value,
  ...
  final Color focusColor;
  final ValueChanged<bool>? onChanged;
  final _CWCommonSwitchState state;
  final TextDirection textDirection;
  final bool isFocused;

  @override
  _RenderCWCommonSwitch createRenderObject(BuildContext context) {
    return _RenderCWCommonSwitch(
      value: value,
      activeColor: activeColor,
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderCWCommonSwitch renderObject) {
...
const double _kTrackWidth = 39.0;
...
const double _kSwitchWidth = 39.0;
const double _kSwitchHeight = 24.0;
// Opacity of a disabled switch, as eye-balled from iOS Simulator on Mac.
const double _kCWCommonSwitchDisabledOpacity = 0.5;

const Duration _kReactionDuration = Duration(milliseconds: 300);
const Duration _kToggleDuration = Duration(milliseconds: 200);

class _RenderCWCommonSwitch extends RenderConstrainedBox {
  _RenderCWCommonSwitch({
    required bool value,
    ...
    required _CWCommonSwitchState state,
  }) : _value = value,
  ...
  final _CWCommonSwitchState _state;
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final double currentThumbExtension = 4.5 * currentReactionValue;
