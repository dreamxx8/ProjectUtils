        ...
        children: [
          CustomGestrureWidget(
            content: "ClipboardUtil",
              child: UtilsItem("剪切板工具类setData(String data)...",
                  "ClipboardUtil.setData(String data) setDataToast(String data)...")),
          Gaps.hGap24,
          CustomGestrureWidget(
            content: "CollectionUtils",
              child: UtilsItem("Map或者List判断空（包含length=0 或者null）", "bool CollectionUtils.isNotBlank(var value)...")),
          Gaps.hGap24,
          CustomGestrureWidget(
            content: "CommonShareNewWidget",
            child: UtilsItem("分享组件 CommonShareNewWidget",
                "CommonShareNewWidget.showCommonShareList(...)"),
          ),
          Gaps.hGap24,
          CustomGestrureWidget(
            content: "StringUtils",
            child: UtilsItem("字符串StringUtils 判断是否为空，相等，数组转字符串，数字转带单位",
